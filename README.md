...
<p align="center"><b>Diagnóstico y codificación de vehículos · Multimarca · Windows</b></p>

<p align="center">
  <img alt="Versión" src="https://img.shields.io/github/v/release/Rannden-SHA/OBD-Master?label=versi%C3%B3n&color=19C8FF">
  <img alt="Descargas" src="https://img.shields.io/github/downloads/Rannden-SHA/OBD-Master/total?label=descargas&color=2ED47A">
  <img alt="Plataforma" src="https://img.shields.io/badge/plataforma-Windows-0E8FD6">
...
![Panel principal](docs/screenshots/01_panel.png)
...
|:--:|:--:|
| ![Diagnóstico](docs/screenshots/02_diagnostico.png) | ![Datos en vivo](docs/screenshots/03_datos.png) |
| **Modo mecánico** | **Conexión multimarca** |
| ![Modo mecánico](docs/screenshots/04_mecanico.png) | ![Conexión](docs/screenshots/07_conexion.png) |
| **Taller · historial** | **Taller · mantenimiento** |
| ![Historial](docs/screenshots/05_taller_historial.png) | ![Mantenimiento](docs/screenshots/06_taller_mantenimiento.png) |
